...
INSERT OR IGNORE INTO user_unit_progress (user_id, unit_id, status, lessons_completed, lessons_total, started_at, completed_at, updated_at)
        SELECT u.id, n.id, 'completed', 5, 5, '2026-04-29T22:08:03.756Z', '2026-05-11T22:08:03.756Z', '2026-05-11T22:08:03.756Z'
...
INSERT OR IGNORE INTO user_unit_progress (user_id, unit_id, status, lessons_completed, lessons_total, started_at, updated_at)
      SELECT u.id, n.id, 'in_progress', 2, 5, '2026-05-10T22:08:03.756Z', '2026-05-13T22:08:03.756Z'
      FROM users u, units n
...
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 51, 'seed', 'seed', 'today', '2026-05-13T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_ronan';
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 51, 'seed', 'seed', 'yesterday', '2026-05-12T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_ronan';
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 618, 'seed', 'seed', 'backfill', '2026-04-29T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_ronan'
...
INSERT OR IGNORE INTO users
      ...
      VALUES (
        ...
        1,
        '2026-05-13',
        '2026-04-22T22:08:03.756Z'
      );
INSERT OR IGNORE INTO user_unit_progress (user_id, unit_id, status, lessons_completed, lessons_total, started_at, completed_at, updated_at)
        SELECT u.id, n.id, 'completed', 5, 5, '2026-04-22T22:08:03.756Z', '2026-05-11T22:08:03.756Z', '2026-05-11T22:08:03.756Z'
        FROM users u, units n
...
INSERT OR IGNORE INTO user_unit_progress (user_id, unit_id, status, lessons_completed, lessons_total, started_at, updated_at)
      SELECT u.id, n.id, 'in_progress', 4, 5, '2026-05-10T22:08:03.756Z', '2026-05-13T22:08:03.756Z'
      FROM users u, units n
      WHERE u.clerk_id = 'seed_mehmet' AND n.slug = 'a2-unit-4-imperfectum';
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 47, 'seed', 'seed', 'today', '2026-05-13T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_mehmet';
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 47, 'seed', 'seed', 'yesterday', '2026-05-12T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_mehmet';
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 886, 'seed', 'seed', 'backfill', '2026-04-22T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_mehmet'
        AND NOT EXISTS (SELECT 1 FROM xp_events e2 WHERE e2.user_id = u.id AND e2.ref_id = 'backfill');
...
INSERT OR IGNORE INTO user_unit_progress (user_id, unit_id, status, lessons_completed, lessons_total, started_at, updated_at)
      SELECT u.id, n.id, 'in_progress', 1, 5, '2026-05-10T22:08:03.756Z', '2026-05-13T22:08:03.756Z'
      FROM users u, units n
      WHERE u.clerk_id = 'seed_judith' AND n.slug = 'a2-unit-4-imperfectum';
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 49, 'seed', 'seed', 'today', '2026-05-13T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_judith';
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 49, 'seed', 'seed', 'yesterday', '2026-05-12T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_judith';
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 592, 'seed', 'seed', 'backfill', '2026-04-29T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_judith'
        AND NOT EXISTS (SELECT 1 FROM xp_events e2 WHERE e2.user_id = u.id AND e2.ref_id = 'backfill');
...
INSERT OR IGNORE INTO users
      ...
      VALUES (
        ...
        1,
        '2026-05-13',
        '2026-05-06T22:08:03.756Z'
      );
INSERT OR IGNORE INTO user_unit_progress (user_id, unit_id, status, lessons_completed, lessons_total, started_at, completed_at, updated_at)
        SELECT u.id, n.id, 'completed', 5, 5, '2026-05-06T22:08:03.756Z', '2026-05-11T22:08:03.756Z', '2026-05-11T22:08:03.756Z'
        FROM users u, units n
...
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 211, 'seed', 'seed', 'today', '2026-05-13T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_michiel';
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 211, 'seed', 'seed', 'yesterday', '2026-05-12T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_michiel';
INSERT INTO xp_events (user_id, delta, reason, ref_type, ref_id, created_at)
      SELECT u.id, 1058, 'seed', 'seed', 'backfill', '2026-05-06T22:08:03.756Z'
      FROM users u WHERE u.clerk_id = 'seed_michiel'
        AND NOT EXISTS (SELECT 1 FROM xp_events e2 WHERE e2.user_id = u.id AND e2.ref_id = 'backfill');
